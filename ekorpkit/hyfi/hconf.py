...
class hConf:
    ...
    def save_data(
        ...
        **kwargs,
        ...
        from ekorpkit.hyfi.io.file import save_data
    ...
    def load_data(filename=None, base_dir=None, filetype=None, verbose=False, **kwargs):
        from ekorpkit.hyfi.io.file import load_data
    ...
    def get_filepaths(
        ...
        from ekorpkit.hyfi.io.file import get_filepaths
    ...
    def concat_data(
        ...
        **kwargs,
        ...
        from ekorpkit.hyfi.io.file import concat_data
    ...
    def is_dataframe(data):
        from ekorpkit.hyfi.io.file import is_dataframe
    ...
    def ensure_import_module(name, libpath, liburi, specname=None, syspath=None):
        from ekorpkit.hyfi.utils.lib import ensure_import_module
    ...
    def collage(
        ...
        **kwargs,
        ...
        from ekorpkit.hyfi.image.collage import collage as _collage
    ...
    def make_gif(
        ...
        **kwargs,
        ...
        from ekorpkit.hyfi.image.motion import make_gif as _make_gif
    ...
    def pip(
        ...
        **kwargs,
        ...
        from ekorpkit.hyfi.utils.lib import pip as _pip
    ...
    def upgrade(prelease=False, quiet=False, force_reinstall=False, **kwargs):
        from ekorpkit.hyfi.utils.lib import pip
    ...
    def get_image_font(fontname=None, fontsize=12):
        from ekorpkit.hyfi.image.collage import get_image_font

        return get_image_font(fontname, fontsize)

    @staticmethod
    def read(uri, mode="rb", encoding=None, head=None, **kwargs):
        from ekorpkit.hyfi.io.file import read as _read
    ...
    def load_image(
        ...
        **kwargs,
        ...
        from ekorpkit.hyfi.image.utils import load_image as _load_image
    ...
    def scale_image(
        ...
        """
        from ekorpkit.hyfi.image.utils import scale_image as _scale_image
