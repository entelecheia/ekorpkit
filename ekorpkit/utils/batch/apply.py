...
def decorator_apply(func, batcher=None, cache=None, vectorize=None, description='batch_apply'):
	def wrapper_func(*args, **kwargs):
		return Apply(func, args=args[1:], kwargs=kwargs, 
				batcher=batcher, cache=cache, vectorize=vectorize, 
...
class Apply(object):
	...
	def __init__(self, function, batcher=None, args=[], kwargs={}, cache=None, vectorize=None, description='batch_apply'):
		if batcher is None:   self.batcher= Batcher()
