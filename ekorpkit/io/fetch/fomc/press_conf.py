...
class PresConfScript(FomcBase):
    ...
    def __init__(self, content_type, **args):
        ...
        right_pct = 0.95 # % Distance of right side of character from left side of page.
    ...
    def _add_article(self, link, index=None):
        ...
        pdf_filepath = self.output_raw_dir + '/FOMC_PresConfScript_' + self._date_from_link(link) + '.pdf'
        ...
        if not os.path.exists(pdf_filepath) or self.force_download:
            ...
            if self.verbose: print("File already exists: ", pdf_filepath)
        ...
        self.articles[index] = self.segment_separator.join([paragraph for paragraph in paragraph_sections])
