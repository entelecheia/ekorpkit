...
class GlassDoor():
	def __init__(self, name, input_file, output_dir, output_file, 
			file_extension, num_workers, force_download,
			**kwargs):
...
def parse_gd_review(review):
	...
	ratings = {}
	srating = review.find('div', class_='subRatings module stars__StarsStyles__subRatings')
	if srating:
	...
	reviews = {}
	review_txt = ''
	rvtexts = review.find_all('div', class_='mt-md common__EiReviewTextStyles__allowLineBreaks')
	if rvtexts:
